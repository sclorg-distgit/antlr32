...
%mvn_compat_version 'org.antlr:antlr3-maven-plugin' %{bootstrap_version}-1 %{version}
%mvn_compat_version 'org.antlr:antlr{,-master,-runtime}' %{bootstrap_version} %{version}
%{?scl:EOF}
...
%changelog
* Fri Jul 10 2015 Mat Booth <mat.booth@redhat.com> - 3.2-9.3
- Fix unowned directories

* Tue Jul 07 2015 Mat Booth <mat.booth@redhat.com> - 3.2-9.2
- Non-bootstrap build

* Tue Jul 07 2015 Mat Booth <mat.booth@redhat.com> - 3.2-9.1
